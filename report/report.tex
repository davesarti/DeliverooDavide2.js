...
handing off to delivery or exploration exactly as an ordinary cold pocket would.
...
\texttt{free\_tile \{x,y\}} & \texttt{(free t\_x\_y)} --- used to ask ``can a crate be moved off this tile'', the goal driving the crate-recovery maneuver \\
\bottomrule
\end{tabular}
